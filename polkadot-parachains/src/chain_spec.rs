...
fn testnet_genesis(
	...
	rococo_parachain_runtime::GenesisConfig {
		...
		democracy: rococo_parachain_runtime::DemocracyConfig::default(),
		council: rococo_parachain_runtime::CouncilConfig::default(),
		technical_committee: rococo_parachain_runtime::TechnicalCommitteeConfig {
